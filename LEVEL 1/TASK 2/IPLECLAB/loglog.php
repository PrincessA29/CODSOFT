   ...
   <body>
    ...
    <!--LOGIN FORM-->
      <div class="wrapper">
         ...
         <form action="loglog.php" method="post">
          <?php include('errors.php'); ?>
            ...
            <button class="btn" name="login" type="submit" style="color: white;">Log In</button>
            </div>
    ...
    <div class="kineme">
        <div class="text">
        <h4>Welcome to Appointway!<hr></h4>
        <div class="a">Your ultimate online scheduling solution.<br>Please Enjoy!</p>
        </div>
        </div>
    </div>
