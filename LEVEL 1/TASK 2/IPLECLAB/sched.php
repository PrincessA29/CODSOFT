   ...
   <body>
    <!--LOGO-->
      ...
      <div class="wrapper">
         ...
         <form action="sched.php" method="post">
            <?php include('errors.php'); ?>
            <div class="field">
                <span class="icon"></span>
               <input type="text" name="name" required>
               <label>Name of the person you want to book</label>
            </div>
            <div class="field">
            ...
            <button class="btn" type="submit" name="Set" style="color: white;">Set</button>
            </div>
         </form>
      </div>
    <!--END-->
    ...
    <!--DESCRIPTION-->
      ...
      <script type="" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
