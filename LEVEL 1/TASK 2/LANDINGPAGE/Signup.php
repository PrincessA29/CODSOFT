...
html,
        body {
            background-image: url(bglibrary.png);
    ...
    <!--LOGIN FORM-->
      <div class="wrapper">
         ...
         <form action="signup.php" method="post">
            ...
            <button class="btn" type="submit" name="register" ONCLICK="alert('Registered successfully!')" style="color: white;">Register</button>
            <button class="btn" type="submit" name="goback" style="color: white;"><a href="loglog.php">Go Back</a></button>
            </div>
